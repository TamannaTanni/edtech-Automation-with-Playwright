...
from add_student_with_batch import add_student_with_batch
...
new_student_without_batch = []
new_student_with_batch = []
...
# @pytest.mark.parametrize("test_data", load_csv_data("csv/new_admin_data.csv"))
...
# @pytest.mark.parametrize("test_data", load_csv_data("csv/new_teacher_data.csv"))
...
# @pytest.mark.dependency(depends=["admin_login"])
# @pytest.mark.parametrize("test_data", load_csv_data("csv/new_student_without_batch_data.csv"))
# def test_add_student_without_batch_with_csv_data(login_with_saved_state, test_data):
#     """
...
#
# @pytest.mark.dependency(depends=["admin_login"])
# @pytest.mark.parametrize("test_data", load_csv_data("csv/new_batch_data.csv"))
...
# @pytest.mark.skip(reason="student already added")
# @pytest.mark.dependency(depends=["admin_login"])
@pytest.mark.parametrize("test_data", load_csv_data("csv/new_student_with_batch_data.csv"))
def test_add_student_with_batch_with_csv_data(login_with_saved_state, test_data):
    """
        Test student creation using data from CSV.
    """
    global new_student_with_batch
    try:
        # Login and create a page instance
        page = login_with_saved_state

        # Perform test cases sequentially
        add_student_with_batch(page, test_data)

        # Save the credentials in a global variable
        new_student_with_batch.append(test_data["firstName"])
